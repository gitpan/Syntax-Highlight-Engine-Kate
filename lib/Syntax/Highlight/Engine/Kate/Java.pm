...
# This file was generated from the 'katexml/java.xml' file of the syntax highlight
# engine of the kate text editor (http://kate.kde.org

#kate xml version 1.15
#kate version 2.4
#kate author Alfredo Luiz Foltran Fialho (alfoltran@ig.com.br)
#generated: Sun May 28 21:18:33 2006, localtime
...
sub parseNormal {
	...
	# type => keyword
	if ($self->testKeyword($text, 'java15', 0, 0, undef, 0, '#stay', 'Java15')) {
		return 1
	}
	# type => Float
