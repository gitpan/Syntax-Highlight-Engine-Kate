...
# This file was generated from the 'katexml/lpc.xml' file of the syntax highlight
...
sub parseNormal {
	...
	# type => keyword
	if ($self->testKeyword($text, 'modifiers', 0, 0, undef, 0, '#stay', 'Modifier')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'types', 0, 0, undef, 0, '#stay', 'Datatype')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'keywords', 0, 0, undef, 0, '#stay', 'Keywords')) {
		return 1
	}
	# type => DetectChar
	...
	# type => Float
	if ($self->testFloat($text, 0, 0, undef, 0, '#stay', 'Floats')) {
		# type => AnyChar
