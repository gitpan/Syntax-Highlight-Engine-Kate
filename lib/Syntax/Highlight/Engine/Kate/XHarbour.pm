...
# This file was generated from the 'katexml/xharbour.xml' file of the syntax highlight
...
sub parseClassContext {
	...
	# type => keyword
	if ($self->testKeyword($text, 'class_keywords', 0, 0, undef, 0, '#stay', 'Keyword')) {
		return 1
	}
	# type => RegExpr
...
sub parseTopLevel {
	...
	# type => keyword
	if ($self->testKeyword($text, 'context_beginners', 0, 0, undef, 0, '#stay', 'Keyword')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'context_terminators', 0, 0, undef, 0, '#stay', 'Keyword')) {
		return 1
	}
	# type => RegExpr
	...
	# type => keyword
	if ($self->testKeyword($text, 'set_commands', 0, 0, undef, 0, '#stay', 'Keyword')) {
		return 1
	}
	# type => keyword
	...
	# type => keyword
	if ($self->testKeyword($text, 'pragma', 0, 0, undef, 0, '#stay', 'Preprocessor')) {
		return 1
	}
	# type => Detect2Chars
