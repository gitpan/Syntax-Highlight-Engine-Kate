...
# This file was generated from the 'katexml/tcl.xml' file of the syntax highlight
# engine of the kate text editor (http://kate.kde.org

#kate xml version 1.08
#kate version 2.4
#generated: Sun May 28 21:18:47 2006, localtime
...
sub parseBase {
	...
	# type => keyword
	if ($self->testKeyword($text, 'keywords-opt', 0, 0, undef, 0, '#stay', 'Parameter')) {
		return 1
	}
	# type => Float
