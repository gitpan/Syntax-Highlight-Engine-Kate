...
# This file was generated from the 'katexml/progress.xml' file of the syntax highlight
...
sub parseNormal {
	my ($self, $text) = @_;
	# type => keyword
	if ($self->testKeyword($text, 'envvariables', 0, 0, undef, 0, '#stay', 'Preprocvar')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'mytypes', 0, 0, undef, 0, '#stay', 'Data_Type')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'operators', 0, 0, undef, 0, '#stay', 'Operators')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'preprocvar', 0, 0, undef, 0, '#stay', 'Preprocvar')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'phrases', 0, 0, undef, 0, '#stay', 'Phrases')) {
		return 1
	}
	# type => keyword
	...
	# type => keyword
	if ($self->testKeyword($text, 'statements', 0, 0, undef, 0, '#stay', 'Statements')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'widgets', 0, 0, undef, 0, '#stay', 'Widgets')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'handles', 0, 0, undef, 0, '#stay', 'Handles')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'properties', 0, 0, undef, 0, '#stay', 'Properties')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'attributes', 0, 0, undef, 0, '#stay', 'Attributes')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'methods', 0, 0, undef, 0, '#stay', 'Methods')) {
		return 1
	}
	# type => Int
