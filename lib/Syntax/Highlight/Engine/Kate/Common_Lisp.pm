...
# This file was generated from the 'katexml/commonlisp.xml' file of the syntax highlight
...
sub parseNormal {
	...
	# type => keyword
	if ($self->testKeyword($text, 'symbols', 0, 0, undef, 0, '#stay', 'Operator')) {
		return 1
	}
	# type => keyword
	...
	# type => keyword
	if ($self->testKeyword($text, 'variables', 0, 0, undef, 0, '#stay', 'Variable')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'definitions', 0, 0, undef, 0, 'function_decl', 'Definition')) {
		return 1
	}
	# type => RegExpr
