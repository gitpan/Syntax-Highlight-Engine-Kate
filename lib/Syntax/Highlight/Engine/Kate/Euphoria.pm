...
# This file was generated from the 'katexml/euphoria.xml' file of the syntax highlight
...
sub parseComment {
	my ($self, $text) = @_;
	# type => keyword
	if ($self->testKeyword($text, 'attention', 0, 0, undef, 0, '#stay', 'Number')) {
		return 1
	}
	return 0;
};
...
sub parseNormal {
	...
	# type => keyword
	if ($self->testKeyword($text, 'GtkKeywords', 0, 0, undef, 0, '#stay', 'GtkKeyword')) {
		return 1
	}
	# type => keyword
	...
	# type => Float
	if ($self->testFloat($text, 0, 0, undef, 0, '#stay', 'Number')) {
		return 1
	}
	# type => Int
