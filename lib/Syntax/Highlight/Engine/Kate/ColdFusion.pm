...
# This file was generated from the 'katexml/coldfusion.xml' file of the syntax highlight
...
sub parsectxCFSCRIPTBlock {
	...
	# type => keyword
	if ($self->testKeyword($text, 'CFSCRIPT Keywords', 0, 0, undef, 0, '#stay', 'Script Keywords')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'CFSCRIPT Functions', 0, 0, undef, 0, '#stay', 'Script Functions')) {
		return 1
	}
	# type => RegExpr
...
sub parsectxSCRIPTBlock {
	...
	# type => keyword
	if ($self->testKeyword($text, 'Script Keywords', 0, 0, undef, 0, '#stay', 'Script Keywords')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'Script Objects', 0, 0, undef, 0, '#stay', 'Script Objects')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'Script Methods', 0, 0, undef, 0, '#stay', 'Script Functions')) {
		return 1
	}
	# type => RegExpr
