...
# This file was generated from the 'katexml/cg.xml' file of the syntax highlight
...
sub parseNormal {
	...
	# type => keyword
	if ($self->testKeyword($text, 'binding', 0, 0, undef, 0, '#stay', 'Binding')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'attention', 0, 0, undef, 0, '#stay', 'Alert')) {
	...
	# type => keyword
	if ($self->testKeyword($text, 'stdstruct', 0, 0, undef, 0, '#stay', 'Data Type')) {
		return 1
	}
	# type => RegExpr
