...
# This file was generated from the 'katexml/octave.xml' file of the syntax highlight
...
sub parse_normal {
	...
	# type => keyword
	if ($self->testKeyword($text, 'commands', 0, 0, undef, 0, '#stay', 'Commands')) {
		return 1
	}
	# type => keyword
	...
	# type => keyword
	if ($self->testKeyword($text, 'builtin', 0, 0, undef, 0, '#stay', 'Builtin')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'forge', 0, 0, undef, 0, '#stay', 'Forge')) {
		return 1
	}
	# type => RegExpr
