...
# This file was generated from the 'katexml/ldif.xml' file of the syntax highlight
# engine of the kate text editor (http://kate.kde.org

#kate xml version 1.02
#kate version 2.4
#kate author Andreas Hochsteger (e9625392@student.tuwien.ac.at)
#generated: Sun May 28 21:18:35 2006, localtime
...
sub parsectxStandard {
	...
	# type => keyword
	if ($self->testKeyword($text, 'attributetypes', 0, 0, undef, 0, '#stay', 'AttributeType')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'objectclasses', 0, 0, undef, 0, '#stay', 'ObjectClass')) {
		return 1
	}
	# type => RegExpr
	if ($self->testRegExpr($text, '[\\w\\-]+((;[\\w\\-]+)+)?:', 0, 0, 0, 0, 0, '#pop', 'Description Keyword')) {
