...
# This file was generated from the 'katexml/doxygen.xml' file of the syntax highlight
# engine of the kate text editor (http://kate.kde.org

#kate xml version 1.24
#kate version 2.4
#kate author Dominik Haumann (dhdev@gmx.de)
#generated: Sun May 28 21:18:28 2006, localtime
...
sub parseBlockComment {
	...
	# type => keyword
	if ($self->testKeyword($text, 'TagOnly', 0, 0, undef, 0, '#stay', 'Tags')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'TagWord', 0, 0, undef, 0, 'ML_TagWord', 'Tags')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'TagWordWord', 0, 0, undef, 0, 'ML_TagWordWord', 'Tags')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'TagString', 0, 0, undef, 0, 'ML_TagString', 'Tags')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'TagWordString', 0, 0, undef, 0, 'ML_TagWordString', 'Tags')) {
		return 1
	}
...
sub parseLineComment {
	...
	# type => keyword
	if ($self->testKeyword($text, 'TagWord', 0, 0, undef, 0, 'SL_TagWord', 'Tags')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'TagWordWord', 0, 0, undef, 0, 'SL_TagWordWord', 'Tags')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'TagString', 0, 0, undef, 0, 'SL_TagString', 'Tags')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'TagWordString', 0, 0, undef, 0, 'SL_TagWordString', 'Tags')) {
		return 1
	}
	# type => DetectIdentifier
	if ($self->testDetectIdentifier($text, 0, undef, 0, '#stay', undef)) {
