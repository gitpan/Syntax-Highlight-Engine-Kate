...
# This file was generated from the 'katexml/rexx.xml' file of the syntax highlight
# engine of the kate text editor (http://kate.kde.org

#kate xml version 1.01
#kate version 2.3
#generated: Sun May 28 21:18:43 2006, localtime
...
sub parseNormal {
	...
	# type => keyword
	if ($self->testKeyword($text, 'builtin', 0, 0, undef, 0, '#stay', 'Built In')) {
		return 1
	}
	# type => RegExpr
