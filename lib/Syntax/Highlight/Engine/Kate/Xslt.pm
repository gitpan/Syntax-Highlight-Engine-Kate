...
# This file was generated from the 'katexml/xslt.xml' file of the syntax highlight
...
sub parsesqxpath {
	my ($self, $text) = @_;
	# type => keyword
	if ($self->testKeyword($text, 'functions', 0, 0, undef, 0, '#stay', 'XPath/ XSLT Function')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'functions_2.0', 0, 0, undef, 0, '#stay', 'XPath 2.0/ XSLT 2.0 Function')) {
		return 1
	}
	# type => RegExpr
...
sub parsetagname {
	my ($self, $text) = @_;
	# type => keyword
	if ($self->testKeyword($text, 'keytags', 0, 0, undef, 0, 'xattributes', 'XSLT Tag')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'keytags_2.0', 0, 0, undef, 0, 'xattributes', 'XSLT 2.0 Tag')) {
		return 1
	}
	# type => RegExpr
