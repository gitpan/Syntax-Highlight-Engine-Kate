...
# This file was generated from the 'katexml/jsp.xml' file of the syntax highlight
# engine of the kate text editor (http://kate.kde.org

#kate xml version 1.02
#kate version 2.4
#kate author Rob Martin (rob@gamepimp.com)
#generated: Sun May 28 21:18:34 2006, localtime
...
sub parseJspExpression {
	...
	# type => keyword
	if ($self->testKeyword($text, 'java-1.4.2-keywords', 0, 0, undef, 0, '#stay', 'Keyword')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'jsp-reserved-words', 0, 0, undef, 0, '#stay', 'Keyword')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'java-1.4.2-types', 0, 0, undef, 0, '#stay', 'Types')) {
		return 1
	}
	# type => keyword
	if ($self->testKeyword($text, 'java-1.4.2-classes', 0, 0, undef, 0, '#stay', 'Java 1.4.2 Classes')) {
		return 1
	}
	# type => Float
