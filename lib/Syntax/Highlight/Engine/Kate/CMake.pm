...
# This file was generated from the 'katexml/cmake.xml' file of the syntax highlight
...
sub parseFunctionArgs {
	...
	# type => keyword
	if ($self->testKeyword($text, 'special_args', 0, 0, undef, 0, '#stay', 'Special Args')) {
		return 1
	}
	# type => RegExpr
...
sub parseNormalText {
	my ($self, $text) = @_;
	# type => keyword
	if ($self->testKeyword($text, 'commands', 0, 0, undef, 0, 'Function Args', 'Commands')) {
		return 1
	}
	# type => RegExpr
